...
echo ""
echo "2. Set Daily.co and OpenAI credentials:"
echo "   export DAILY_ROOM_URL=https://your-domain.daily.co/your-room"
echo "   export OPENAI_API_KEY=sk-..."
echo "   # Or use the Gradio launcher (auto-creates rooms):"
echo "   #   export DAILY_API_KEY=your-daily-api-key"
echo "   #   python gradio_room_launcher.py"
echo ""
echo "3. Run the bot:"
echo "   ./run_bot.sh"
echo ""
