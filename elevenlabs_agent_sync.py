...
from pipecat.frames.frames import AudioRawFrame, StartFrame, TextFrame, EndFrame
...
class ElevenLabsAgentProcessor(FrameProcessor):
            ...
            while self.is_running and self.ws:
                ...
                if data.get("type") in ("conversation_initiation_metadata_event", "conversation_initiation_metadata"):
                    ...
                    if audio_b64:
                        ...
                        # Push audio downstream to WebRTCSyncPusher
    ...
    async def process_frame(self, frame, direction):
        if isinstance(frame, StartFrame):
            ...
            # Drop mic audio so it doesn't get echoed to the avatar
            return
        else:
            await super().process_frame(frame, direction)
...
async def main():
    try:
        ...
        logger.info(f'Starting ElevenLabs Agent WebRTC streaming bot in {room_name}...')
